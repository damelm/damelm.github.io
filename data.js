...
const COPY = {
  es: {
    ...
    formLabel: 'O dejanos tus datos', formName: 'Nombre', formCompany: 'Empresa (opcional)', formEmail: 'Email', formMsg: '¿Qué necesitás?', formSend: 'Enviar', formSending: 'Enviando…', formOk: '¡Gracias! Te respondemos a la brevedad.', formErr: 'No se pudo enviar. Escribinos por WhatsApp: +595 992 879 800.',
  ...
  en: {
    ...
    heroSub: 'At Zeeben Labs we build the software, automation and infrastructure your company needs — powered by AI — from idea to working product. Fast, custom and low-cost.',
    heroCta1: "Let's talk", heroCta2: 'See work', heroCtaAI: 'Ask our AI assistant',
    svcLabel: 'Services', svcTitle: 'What we solve',
    casesLabel: 'Work', casesTitle: 'Real projects, in production',
    osLabel: 'Open source', osTitle: 'Open code you can inspect', osIntro: "We don't just say it: part of what we build is public and anyone can review it.",
    ...
    aboutLabel: 'Founder', aboutTitle: 'Who is behind Zeeben Labs',
    aboutP1: 'Zeeben Labs is built on the experience of Damian Peña: 15+ years in networking, infrastructure and IT support, solving real problems in companies. We know what happens when technology gets in the way — and how to fix it.',
    aboutP2: 'Today we combine that experience with AI to build custom software: what once needed a whole team, we now prototype, secure and ship to production — fast, custom and low-cost.',
    ...
    contactHead: "Let's put your tech to work for you.", contactSub: "Tell us what you need and we'll figure it out. We reply fast, no strings attached.", contactBtn: "Let's talk on WhatsApp", contactDownload: 'CV as PDF', location: 'Argentine team, operating from Asunción for the whole world.',
    formLabel: 'Or leave us your details', formName: 'Name', formCompany: 'Company (optional)', formEmail: 'Email', formMsg: 'What do you need?', formSend: 'Send', formSending: 'Sending…', formOk: "Thanks! We'll get back to you shortly.", formErr: 'Could not send. Reach us on WhatsApp: +595 992 879 800.',
    footerNote: 'Technology end to end · from A to Z',
    now: 'NOW'
  }
};
