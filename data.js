...
const COPY = {
  es: {
    ...
    heroCta1: 'Hablemos', heroCta2: 'Ver proyectos',
    ...
    aboutLabel: 'Sobre mí', aboutTitle: 'De la infraestructura al software',
    aboutP1: 'Vengo de redes, infraestructura y soporte IT, con más de 15 años resolviendo problemas reales en empresas. Conozco lo que pasa cuando la tecnología no acompaña — y cómo arreglarlo.',
    aboutP2: 'En los últimos años me apoyé fuerte en IA para construir software a medida: lo que antes necesitaba un equipo entero, hoy lo prototipo, aseguro y dejo en producción yo mismo, rápido y a bajo costo.',
  ...
  en: {
    ...
    heroCta1: "Let's talk", heroCta2: 'See work',
